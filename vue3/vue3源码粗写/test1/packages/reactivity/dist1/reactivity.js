...
// packages/reactivity/src1/effect.ts
...
// packages/reactivity/src1/reactive.ts
var allReactiveMap = /* @__PURE__ */ new Map();
function reactive2(obj) {
  ...
  if (obj["isAlreadyReactive" /* IS_ALREADY_REACTIVE */]) {
    return obj;
  }
  return new Proxy(obj, {
    get(target, key, reciever) {
      track2(target, key, reciever);
...
var allEffectMap = /* @__PURE__ */ new WeakMap();
function track2(target, key, reciever) {
  if (!activeEffect) {
    return;
  }
  let objectDepsMap = allEffectMap.get(target);
  if (!objectDepsMap) {
    allEffectMap.set(objectDepsMap, objectDepsMap = /* @__PURE__ */ new Map());
  }
  let keyDepsMap = objectDepsMap.get(key);
  if (!keyDepsMap) {
    objectDepsMap.set(key, keyDepsMap = /* @__PURE__ */ new Map());
